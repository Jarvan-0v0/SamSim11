...
(function ($) {
    ...
    $.fn.treeview = function (settings) {
        var dfop =
            {
                 ...
                 * 2016 xbm
                 */
                cbiconpath:  "../scripts/tree/Images/icons/",
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            //alert( nd.img);
            if (nd.img != undefined) {
                //2016xbm _img = "<img style='vertical-align: middle;width:16px;height:16px;padding-bottom:2px;padding-right:2px;' src='" + RootPath() + nd.img + "'/>";
